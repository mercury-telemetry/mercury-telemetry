# Generated by Django 2.2.11 on 2020-03-11 00:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sensor_type_name', models.CharField(blank=True, max_length=1024)),
                ('sensor_type_processingFormula', models.IntegerField(default=0)),
                ('sensor_type_format', django.contrib.postgres.fields.jsonb.JSONField()),
            ],
        ),
        migrations.CreateModel(
            name='AGVenue',
