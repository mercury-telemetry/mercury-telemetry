...
urlpatterns = [
    ...
    path("events/updatevenue/<uuid:venue_uuid>", events.update_venue, name="update_venue"),
    path("events/activateevent/<uuid:event_uuid>", events.activate_event, name="activate_event"),
    path("events/deactivateevent/<uuid:event_uuid>", events.deactivate_event, name="deactivate_event"),
    ...
    path("events/export/<uuid:event_uuid>/json", events.export_event, name="export_json"),
