...
class TestCANViews(TestCase):
    ...
    def test_wheel_speed_sensor_missing_data(self):
        response = self.client.post(
            reverse("mercury:can-api"),
            data={
                "can_msg": 0b10000000001100001100000000000000001000000000000001000000000000000110000000000000001110000000000  # noqa E501
            },
        )
        self.assertEqual(400, response.status_code)
    ...
    def test_suspension_sensor_missing_data(self):
        response = self.client.post(
            reverse("mercury:can-api"),
            data={
                "can_msg": 0b10000000010000001100000000000000001000000000000001000000000000000110000000000000001110000000000  # noqa E501
            },
        )
        self.assertEqual(400, response.status_code)
